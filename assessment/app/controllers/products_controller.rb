class ProductsController < ApplicationController
  ...
  private
    ...
    def product_params
      params.require(:product).permit(:title, :author, :price, :discount, :category, :sale_or_rent, :description, :ages, :format, :pages, :publication_date, :publisher, :publication_city, :language, :isbn, :user_id, :stock, {product_images: []})
    end
end
